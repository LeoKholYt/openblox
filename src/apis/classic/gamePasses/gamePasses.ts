...
import type {
  PrettifiedGamePassDetails,
  PrettifiedGamePassesForUniverseData,
  PrettifiedGamePassInfo,
  RawGamePassDetails,
  RawGamePassesForUniverseData,
  RawGamePassInfo,
} from "./gamePasses.types";
import type { Identifier } from "typeforge";
import { readFile } from "../../../file";
//////////////////////////////////////////////////////////////////////////////////

// [ Variables ] /////////////////////////////////////////////////////////////////
const { createApiMethod } = createApiGroup({
  name: "ClassicGamePasses",
  baseUrl: "https://apis.roblox.com/game-passes",
});
//////////////////////////////////////////////////////////////////////////////////
 ...
 */
export const gamePassInfo = createApiMethod(
  async <GamePassId extends Identifier>({
    gamePassId,
  }: {
    gamePassId: GamePassId;
  }): ApiMethod<
    RawGamePassInfo<GamePassId>,
    PrettifiedGamePassInfo<GamePassId>
  > => ({
    method: "GET",
    ...
    formatRawDataFn: (rawData) =>
      cloneAndMutateObject(toCamel(rawData), (obj) => {
...
/**
 * Gets details about a game pass.
 * @endpoint GET /v1/game-passes/{gamePassId}/details
 *
 * @param gamePassId The ID of the game pass to get information about.
 *
 * @example const { data:gamePassDetails } = await ClassicGamePassesApi.gamePassDetails({ gamePassId: 9260480 })
 * @exampleData "targetId":9260480,"productType":"Game Pass","assetId":0,"productId":979386303,"name":"Donate","description":"null","assetTypeId":0,"creator":{"id":1536374574,"name":"MightyPart Games","creatorType":"Group","creatorTargetId":5850082},"iconImageAssetId":5316458121,"created":"2020-05-01T15:05:21.543Z","updated":"2020-07-09T13:08:21.133Z","priceInRobux":15,"priceInTickets":null,"sales":6,"isNew":false,"isForSale":true,"isPublicDomain":false,"isLimited":false,"isLimitedUnique":false,"remaining":null,"minimumMembershipLevel":0}
 * @exampleRawBody {"gamePassId":115278177,"name":"Tiger","description":"","isForSale":true,"iconAssetId":13924641430,"placeId":11934450703,"createdTimestamp":"2022-12-27T21:11:04.35Z","updatedTimestamp":"2023-07-01T18:59:56.753Z","priceInformation":{"defaultPriceInRobux":25,"enabledFeatures":[]}}
 */
export const gamePassDetails = createApiMethod(
  async <GamePassId extends Identifier>({
    gamePassId,
  }: {
    gamePassId: GamePassId;
  }): ApiMethod<
    RawGamePassDetails<GamePassId>,
    PrettifiedGamePassDetails<GamePassId>
  > => ({
    method: "GET",
    ...
    formatRawDataFn: (rawData) =>
      cloneAndMutateObject(rawData, (obj) => {
        obj.createdTimestamp = new Date(obj.createdTimestamp);
        obj.updatedTimestamp = new Date(obj.updatedTimestamp);
      }),
  })
);
 ...
 */
export const gamePassesForUniverse = createApiMethod(
  async ({
    universeId,
    limit = 10,
    cursor,
 ...
 * @exampleRawBody ""
 */
export const updateGamePass = createApiMethod(
  async ({
    gamePassId,
    name,
    description,
    ...
    formData: formDataBuilder()
      ...
      .append(
        "File",
        typeof icon == "string"
          ? new File([new Blob([await readFile(icon)])], "File")
          : icon
      ),
    name: `updateGamePass`,
 ...
 */
export const createGamePass = createApiMethod(
  async ({
    universeId,
    name,
    description,
